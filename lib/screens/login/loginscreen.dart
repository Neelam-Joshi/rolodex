      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child:getText("Log In", 40, FontWeight.w700, Colors.white ,poppinsRegular)
            ),
            ...
            Expanded(
              child: Container(
                ...
                child: ListView(
                    //crossAxisAlignment: CrossAxisAlignment.start,
                    children:[
                      getText("Log in with one of the following options", 10, FontWeight.w700, Colors.black, poppinsRegular),
                      ...
                      InkWell(
                        ...
                        child: Container(
                            ...
                            child: getText("Log In", 17, FontWeight.w700, Colors.white, poppinsRegular)
                        ),
                      ),
                      const SizedBox(height:16),
                      InkWell(
                        ...
                        child: Container(
                            ...
                            child: getText("Sign Up", 17, FontWeight.w700, Colors.white, poppinsRegular)
                        ),
                      ),
                    ]),
              ),
